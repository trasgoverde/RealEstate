...
export class PropertyComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.propertyService
        ...
        .subscribe(
          (res: HttpResponse<IProperty[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInProperties(): void {
    this.eventSubscriber = this.eventManager.subscribe('propertyListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProperty[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
